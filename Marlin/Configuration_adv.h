...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true // by Lori
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  27.5f       // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.14f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  27.5f       // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.14f       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
...
#define G0_FEEDRATE 7500 // (mm/min)
#ifdef G0_FEEDRATE
